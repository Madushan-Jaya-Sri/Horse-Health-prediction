...
xgb_model = joblib.load('/Users/jayasri/Documents/malsha/untitled folder/xgboost_model_new.pkl')

# Load label encoders
with open('/Users/jayasri/Documents/malsha/untitled folder/label_encoders_new.pkl', 'rb') as f:
...
def main():
    ...
    # Load DataFrame
    df = pd.read_csv('/Users/jayasri/Documents/malsha/train.csv')
